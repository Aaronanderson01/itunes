  ...
  //First inject itunesService into your controller.
    ...
    $scope.getSongData= function(){
      ...
      for (var x=0; x<songs.length; x++) {
        $scope.songData.push({
          AlbumArt: songs[x].artworkUrl100,
          Artist: songs[x].artistName,
          Collection: songs[x].collectionName,
          CollectionPrice: songs[x].collectionPrice,
          Type: songs[x].kind,
          Play: songs[x].previewUrl,
          trackName: songs[x].trackName
        });
      }
